CLASS zcx_cnsmm_rap DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    DATA: attr1 TYPE string READ-ONLY,
          attr2 TYPE matnr READ-ONLY,
          attr3 TYPE matnr READ-ONLY,
          attr4 TYPE matnr READ-ONLY.


    CONSTANTS: BEGIN OF material_unknown,
                 msgid TYPE symsgid VALUE 'ZCNSMM_MSG_MANAGED',
...
CLASS zcx_cnsmm_rap IMPLEMENTATION.
